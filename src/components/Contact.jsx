...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      {/* Watermark */}
      <div style={{
        position:'absolute', bottom:'-1.5rem', left:'-0.5rem',
        fontFamily:"'Bebas Neue',sans-serif", fontSize:'clamp(80px,18vw,200px)',
        lineHeight:1, color:'rgba(200,168,78,0.022)', pointerEvents:'none', userSelect:'none', letterSpacing:'0.06em',
      }}>QUOTE</div>
