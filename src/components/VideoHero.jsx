...
// Each chapter window ≥ 38 frames; non-overlapping; FRAME_FADE=18 on each edge.
const CHAPTERS = [
  // ── 3d: 0–144 ──
  {
    frameRange: [0, 144],
  ...
  // ── frames2: 145–390 — 5 evenly-spaced chapters (~45 frames each) ──
  {
    frameRange: [145, 189],
